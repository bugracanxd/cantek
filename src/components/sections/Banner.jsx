    ...
    <section className="site-container my-14">
      ...
      >
        ...
        <div className="relative z-10 p-10">
          ...
          {data.description && <p className="mb-5 opacity-90 font-light">{data.description}</p>}
          {data.buttonText && (
            <a href={data.buttonLink || "#"} className="btn-primary inline-flex items-center gap-2 px-5 py-2.5 text-sm group">
              {data.buttonText}
